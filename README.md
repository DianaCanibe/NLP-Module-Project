...
Finally for the translation I used "googletrans" and "Helsinki-NLP/opus-mt-es-en", the translation was made from spanish to english, an evaluated using the english original text. 
